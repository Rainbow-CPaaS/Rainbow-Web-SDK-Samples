    ...
    controller : function rbcConnectionCtrl(rainbowSDK, $rootScope, $scope) {
        ...
        var changeRecipientValue = function changeRecipientValue() {
            if ($scope.selectedItem) {
                ...
                $scope.actionSharing = $scope.presenceValue === "notAvailable" ? "Not Available" : $scope.presenceValue === "busy" ? "Busy" : "Sharing Call";
        ...
        $scope.callSharing = function callSharing() {
            ...
            if ($scope.selectedItem) {
                rainbowSDK.webRTC.canMakeDesktopSharingCall()
                .then( function() {
